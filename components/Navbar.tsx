...
export default function Navbar() {
  ...
  return (
    <header className="animate-fade-in opacity-0 w-full mx-auto px-4 sm:px-20 fixed top-0 z-50 shadow bg-white dark:bg-stone-900 dark:border-b dark:border-stone-600">
